...
function EngineeringPanel() {
	...
	function initialJsLibraries(pExtraLibraries) {
		var jsLibs = {
			...
			cestore_01: { url:'/ce-store/ui/js/renderers/renderer-actions.js', loaded: false },
			cestore_02: { url:'/ce-store/ui/js/renderers/renderer-concepts.js', loaded: false },
			cestore_03: { url:'/ce-store/ui/js/renderers/renderer-instances.js', loaded: false },
			cestore_04: { url:'/ce-store/ui/js/renderers/renderer-messages.js', loaded: false },
			cestore_05: { url:'/ce-store/ui/js/renderers/renderer-models.js', loaded: false },
			cestore_06: { url:'/ce-store/ui/js/renderers/renderer-patterns.js', loaded: false },
			cestore_07: { url:'/ce-store/ui/js/renderers/renderer-properties.js', loaded: false },
			cestore_08: { url:'/ce-store/ui/js/renderers/renderer-rationale.js', loaded: false },
			cestore_09: { url:'/ce-store/ui/js/renderers/renderer-sentences.js', loaded: false },
			cestore_10: { url:'/ce-store/ui/js/renderers/renderer-sources.js', loaded: false },
			cestore_11: { url:'/ce-store/ui/js/renderers/renderer-stores.js', loaded: false },

			cestore_12: { url:'/ce-store/ui/js/handlers/handler-actions.js', loaded: false },
			cestore_13: { url:'/ce-store/ui/js/handlers/handler-concepts.js', loaded: false },
			cestore_14: { url:'/ce-store/ui/js/handlers/handler-instances.js', loaded: false },
			cestore_15: { url:'/ce-store/ui/js/handlers/handler-messages.js', loaded: false },
			cestore_16: { url:'/ce-store/ui/js/handlers/handler-models.js', loaded: false },
			cestore_17: { url:'/ce-store/ui/js/handlers/handler-patterns.js', loaded: false },
			cestore_18: { url:'/ce-store/ui/js/handlers/handler-properties.js', loaded: false },
			cestore_19: { url:'/ce-store/ui/js/handlers/handler-rationale.js', loaded: false },
			cestore_20: { url:'/ce-store/ui/js/handlers/handler-sentences.js', loaded: false },
			cestore_21: { url:'/ce-store/ui/js/handlers/handler-sources.js', loaded: false },
			cestore_22: { url:'/ce-store/ui/js/handlers/handler-stores.js', loaded: false },

			dialog_01: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb.js', loaded: false },
			dialog_02: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb-actions.js', loaded: false },
			dialog_03: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb-dialog.js', loaded: false },
			dialog_04: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb-drawing.js', loaded: false },
			dialog_05: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb-generation.js', loaded: false },
			dialog_06: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb-links.js', loaded: false },
			dialog_07: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb-menu.js', loaded: false },
			dialog_08: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb-model.js', loaded: false },
			dialog_09: { url:'/ce-store/ui/js/dialogs/ceqb/dialog-ceqb-move.js', loaded: false },
			...
			dialog_18: { url:'/ce-store/ui/js/dialogs/conv/dialog-conv-links.js', loaded: false },

			dialog_20: { url:'/ce-store/ui/js/dialogs/dialog-config.js', loaded: false },
			dialog_21: { url:'/ce-store/ui/js/dialogs/dialog-sentence.js', loaded: false },
			dialog_22: { url:'/ce-store/ui/js/dialogs/dialog-user.js', loaded: false },

			ui_01: { url:'/ce-store/ui/js/ui/ui.js', loaded: false },
			ui_02: { url:'/ce-store/ui/js/ui/links.js', loaded: false },
			ui_03: { url:'/ce-store/ui/js/ui/panes/pane-action.js', loaded: false },
			ui_04: { url:'/ce-store/ui/js/ui/panes/pane-addce.js', loaded: false },
			ui_05: { url:'/ce-store/ui/js/ui/panes/pane-ceqb.js', loaded: false },
			ui_06: { url:'/ce-store/ui/js/ui/panes/pane-concept.js', loaded: false },
			ui_07: { url:'/ce-store/ui/js/ui/panes/pane-config.js', loaded: false },
			ui_08: { url:'/ce-store/ui/js/ui/panes/pane-conversation.js', loaded: false },
			ui_10: { url:'/ce-store/ui/js/ui/panes/pane-debug.js', loaded: false },
			ui_12: { url:'/ce-store/ui/js/ui/panes/pane-entity.js', loaded: false },
			ui_13: { url:'/ce-store/ui/js/ui/panes/pane-error.js', loaded: false },
			ui_14: { url:'/ce-store/ui/js/ui/panes/pane-general.js', loaded: false },
			ui_15: { url:'/ce-store/ui/js/ui/panes/pane-pattern.js', loaded: false },
			ui_16: { url:'/ce-store/ui/js/ui/panes/pane-search.js', loaded: false },
			ui_17: { url:'/ce-store/ui/js/ui/panes/pane-sentence.js', loaded: false },
			ui_18: { url:'/ce-store/ui/js/ui/panes/pane-source.js', loaded: false },
			ui_19: { url:'/ce-store/ui/js/ui/panes/pane-status.js', loaded: false },
			ui_20: { url:'/ce-store/ui/js/ui/panes/pane-timeline.js', loaded: false },
			ui_21: { url:'/ce-store/ui/js/ui/panes/pane-warning.js', loaded: false },
			ui_22: { url:'/ce-store/ui/js/ui/panes/pane-info.js', loaded: false },

			ui_23: { url:'/ce-store/ui/js/ui/forms/form-choosefilter.js', loaded: false },
			ui_24: { url:'/ce-store/ui/js/ui/forms/form-chooserel.js', loaded: false },
			ui_25: { url:'/ce-store/ui/js/ui/forms/form-editce.js', loaded: false },
			ui_26: { url:'/ce-store/ui/js/ui/forms/form-login.js', loaded: false }
		};
