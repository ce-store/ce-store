...
function DialogConvHandler() {
  ...
  var HTML_IRT_LINK = '<a href="#%IRT%" title="is in reply to %IRT%"><img src="/ce-store/ui/icons/link.png" width="10" height="10"></a>';
...
//			}
    ...
    if (toTokens.length == 0) {
      if (typeToken == CON_TELLCARD) {
        toTokens.push(TELL_PARTNER);
      } else {
