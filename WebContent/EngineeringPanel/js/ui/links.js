...
function CeStoreLinks() {
	...
	this.externalHyperlinkFor = function(pUrl) {
		return this.hyperlinkFor(pUrl, '<img src="/CeStore/EngineeringPanel/icons/link.png" height="15"/>', 'Open this link in a new window', '_blank');
	};
	...
	this.help = function() {
		return this.hyperlinkFor('/CeStore/doc/index.html', 'help', 'Open the help page', TARGET_POPUP);
	};
