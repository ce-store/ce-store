...
public class ModelBuilder implements PersistableStore {
	...
	private static final String CELOG_FILENAME = "all_ce_sentences.ce";
	...
	public String calculateCeLoggingFilename() {
		return getCeStoreName() + "_" + ModelBuilder.CELOG_FILENAME;
	}
...
//			if (totalSens == 0) {
//				reportDebug("NO NEW SENTENCES INFERRED (" + srcId + ")", pAc);
//			} else {
