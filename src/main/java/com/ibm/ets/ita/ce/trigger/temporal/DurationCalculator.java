package com.ibm.ets.ita.ce.trigger.temporal;
...
public class DurationCalculator extends CeNotifyHandler {
    ...
    private long getTimePropertyValue(ActionContext pAc, CePropertyInstance pi) {
        ...
        if (relatedProp.isDatatypeProperty()) {
            ...
            format = "yyyy-MM-dd"; //TODO: This should not be hardcoded
        }
    ...
    private String getValueFromInstance(ActionContext pAc, CeInstance pInst) {
    	...
    	String result = "";
        String yearVal = pInst.getSingleValueFromPropertyNamed("year");
        String monthVal = pInst.getSingleValueFromPropertyNamed("month");
        String dayVal = pInst.getSingleValueFromPropertyNamed("day");
    ...
    public void notify(ActionContext pAc, String pThingType, String pThingName, String pTriggerName, String pSourceId,
        ...
        CePropertyInstance tspi = trigger.getPropertyInstanceNamed("start property");
        CePropertyInstance tepi = trigger.getPropertyInstanceNamed("end property");
        CePropertyInstance tdpi = trigger.getPropertyInstanceNamed("duration property");
        CePropertyInstance udpi = trigger.getPropertyInstanceNamed("unended duration property");
        CePropertyInstance tcpi = trigger.getPropertyInstanceNamed("current property");
        CePropertyInstance tgci = trigger.getPropertyInstanceNamed("generate current");
        CePropertyInstance ctoi = trigger.getPropertyInstanceNamed("current time override");
