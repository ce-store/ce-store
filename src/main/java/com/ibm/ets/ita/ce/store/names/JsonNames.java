...
public class JsonNames {
	...
	public static final String JSON_A_C_ID = "id";
	public static final String JSON_A_C_LAT = "lat";
	public static final String JSON_A_C_LON = "lon";
	public static final String JSON_A_M_ID = "id";
	public static final String JSON_A_M_URL = "url";
	public static final String JSON_A_M_CREDIT = "credit";
