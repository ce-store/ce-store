...
//	function compareInterpretQuestion(pAr1, pAr2, pMaxDepth, pErrCode) {
//		var result = "";
//
//		//text
//		result += compareSimpleValues(pAr1.text, pAr2.text, pErrCode + '.T');
//
//		//words
//		result += compareArrayValues(pAr1.words, pAr2.words, pErrCode + '.W');
//
//		return result;
//	}
//
//	function compareInterpretInterpretations(pList1, pList2, pMaxDepth, pErrCode) {
//		var result = "";
//
...
//						var thisItem = pList1[i];
//
//						result += compareThisInterpretation(pList1[i], pList2[i], pMaxDepth, pErrCode + "." + i);
//					}
//				} else {
...
//	}
//
//	function compareThisInterpretation(pAr1, pAr2, pMaxDepth, pErrCode) {
//		var result = "";
//
//		//confidence
//		result += compareSimpleValues(pAr1.confidence, pAr2.confidence, pErrCode + ".C");
//
//		//explanation
//		result += compareSimpleValues(pAr1.explanation, pAr2.explanation, pErrCode + ".E");
//
//		//result
//		result += compareThisInterpretationResult(pAr1.result, pAr2.result, pMaxDepth, pErrCode + ".R");
//
//		return result;
//	}
//
//	function compareThisInterpretationResult(pAr1, pAr2, pMaxDepth, pErrCode) {
//		var result = "";
//
//		//concepts
//		result += compareConcepts(pAr1.concepts, pAr2.concepts, pErrCode + '.C');
//
//		//properties
//		result += compareProperties(pAr1.properties, pAr2.properties, pErrCode + '.P');
//
//		//instances
//		result += compareInstances(pAr1.instances, pAr2.instances, pErrCode + '.I');
//
//		//specials
//		result += compareSpecials(pAr1.specials, pAr2.specials, pErrCode + '.S');
//
//		return result;
//	}
//
...
//				result += errText + ".!2";
//			} else {
//				result += compareSimpleValues(pEnt1["phrase"], pEnt2["phrase"], errText + '.P')
//				
//				if (result == "") {
//					result += compareSimpleValues(pEnt1["start position"], pEnt2["start position"], errText + '.SP')
//				}
//
//				if (result == "") {
//					result += compareSimpleValues(pEnt1["end position"], pEnt2["end position"], errText + '.EP')
//				}
//
//				if (result == "") {
//					result += compareMmInstances(pEnt1["entities"], pEnt2["entities"], pPos, errText + '.EN')
//				}
//			}
//		} else {
//			//Both are null - nothing needed
...
//	}
//
//	function compareMmInstances(pList1, pList2, pMaxDepth, pErrCode) {
//		var result = "";
//
//		if (pList1 != null || pList2 != null) {
//			if (pList1 == null) {
...
//						var thisItem = pList1[i];
//
//						result += compareMmInstance(pList1[i], pList2[i], i, pErrCode + "." + i);
//					}
//				} else {
//					result += pErrCode + '#'; //The number of items don't match
//				}
...
//					} else if (pSpec1.type == 'matched-triple') {
//						result += compareThisSpecialMatchedTriple(pSpec1, pSpec2, errCode);
//					} else {
...
//	}
//
//	function compareThisSpecialMatchedTriple(pSpec1, pSpec2, pErrCode) {
//		var result = '';
//		
//		result += compareSimpleValues(pSpec1.type, pSpec2.type, pErrCode + '.T')
//		result += compareSimpleValues(pSpec1.name, pSpec2.name, pErrCode + '.Na')
//		result += compareSimpleValues(pSpec1.position, pSpec2.position, pErrCode + '.P')
//		result += compareStandardEntity(pSpec1.predicate, pSpec2.predicate, pErrCode + ".Pred");
//		result += compareConcepts(pSpec1.subjects, pSpec2.subjects, pErrCode + ".Sub");
//		result += compareConcepts(pSpec1.objects, pSpec2.objects, pErrCode + ".Obj");
//		
//		return result;
//	}
//
...
//		console.log(pSpec1);
//		console.log(pSpec2);
//		result += compareSimpleValues(pSpec1["phrase"], pSpec2["phrase"], pErrCode + '.P')
//		result += compareSimpleValues(pSpec1["start position"], pSpec2["start position"], pErrCode + '.SP')
//		result += compareSimpleValues(pSpec1["end position"], pSpec2["end position"], pErrCode + '.SP')
//		result += compareSimpleValues(pSpec1["connector"], pSpec2["connector"], pErrCode + '.Con')
//		result += compareSpecialCollectionContents(pSpec1["collection"], pSpec2["collection"], pErrCode + ".Coll");
//		
//		return result;
//	}
//
